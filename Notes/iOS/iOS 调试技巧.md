...
## 前言
作为一个合格的 iOS程序员，掌握一些基础的调试技巧，不但有利于提升解决问题的效率，而且也有利于发现问题的本质。下面就简单介绍日常开发中可能用到的一些调试技巧。

## 断点 (Breakpoint)
断点用来暂停程序运行，实时查看符号和对象。Xcode 支持多种不同类型的断点。例如：Swift错误断点、异常断点、符号断点等。下面就来介绍一些断点的使用场景。
